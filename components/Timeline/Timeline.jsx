...
const Item = ({ title, date, description }) => {
  return (
    <li className="mb-10 ml-10">
      <span className="absolute -left-4 flex h-8 w-8 items-center justify-center bg-sky-400 ring-8 ring-gray-50 dark:bg-sky-600 dark:ring-gray-900">
        <CalendarIcon className="h-5 w-5 text-white" />
      </span>
      <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-gray-200">
        {title}
      </h3>
      <time className="mb-2 block text-sm font-normal leading-none text-gray-400 dark:text-gray-400">
        {date}
      </time>
